...
celery = Celery('worker', backend='rpc://', broker='amqp://guest:guest@127.0.0.1:5672//')
...
class TaskScheduler(object):
    ...
    def schedule(func, description, args=None, kwargs=None, rrule_string=None,
        ...
        kwargs.update({
            ...
            'rrule_string': dict(rrule_string),
        ...
        celery_args = {"eta":_trigger_at, "args":args, "kwargs":kwargs}
        # scheduled_task_id = func.apply_async(eta=_trigger_at, args=args, kwargs=kwargs)
        scheduled_task_id = celery.signature(func, kwargs=kwargs).apply_async(eta=_trigger_at)
